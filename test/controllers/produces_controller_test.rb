...
class ProducesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produce" do
    assert_difference('Produce.count') do
      post produces_url, params: { produce: { name: @produce.name, price: @produce.price, vendor: @produce.vendor } }
    end
  ...
  test "should update produce" do
    patch produce_url(@produce), params: { produce: { name: @produce.name, price: @produce.price, vendor: @produce.vendor } }
